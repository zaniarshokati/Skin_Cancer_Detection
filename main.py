...
class Application:
    def __init__(self) -> None:
        ...
        self.TRAIN_PATH = "dataset_2/train/*/*.jpg"
        self.TEST_PATH = "dataset_2/test/*/*.jpg"

    def main(self):
        # Load and preprocess data

        df_train = self.data_processor.load_train_data(self.TRAIN_PATH)
        df_test = self.data_processor.load_test_data(self.TEST_PATH)
